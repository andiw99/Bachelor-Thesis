...
def main():
    ...
    save_path = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/pythonProject/Results/reweigth+analytic/"
    file_name = "reweight+analytic"
    ...
    model_paths[
        "reweight_3"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/pythonProject/Files/Reweight/Models/best_parameters_2_0"
    model_paths[
        "reweight_4"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/pythonProject/Files/Reweight/Models/best_parameters_2_1"
    ...
    for model in models:
        ...
        for dataset in features:
            time_pre_calc = timeit.default_timer()
            ...
            calc_times[model][dataset] = (timeit.default_timer() - time_pre_calc)/ ((repeat-2) * len(labels[dataset]))  * 1e+6
            # losses berechnen
