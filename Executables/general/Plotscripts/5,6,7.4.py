...
paths = dict()
model_paths = dict()
model_paths["Predictions"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Files/Hadronic/Models/scaling_logarithm_theta_config"
#model_path= "/Files/Hadronic/Models/best_guess_4M"
#more data to plot?
#PlottingDataLowX_data = ...

#Pfade in dict speichern
paths["$\eta, x_1$ constant"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Files/Hadronic/Data/PlottingDataLowX/eta_x_1_constant"
paths["$x_1, x_2$ constant"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Files/Hadronic/Data/PlottingDataLowX/x_constant"
paths["$\eta, x_2$ constant"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Files/Hadronic/Data/PlottingDataLowX/eta_x_2_constant"
...
for dataset in predictions:
    ...
    ml.plot_model(features_pd=features_pd[dataset], labels=labels[dataset], predictions=predictions[dataset],
                  keys=keys, save_path=save_path, trans_to_pb=True, text_loc=text_loc, text_loc_log=text_loc_log,
                  autoscale=True, set_ratio_yscale="linear", automatic_legend=True, figsize=figsize, set_label_coords=set_label_coords)
