...
paths = dict()
paths[r"$x^4$-Distribution"] = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Files/Partonic/PartonicData/PlottingData2k_ep_0.163/"
save_path = "/home/andiw/Documents/Semester 6/Bachelor-Arbeit/Bachelor-Arbeit/Plots/finished/"
name = "4_colorchange"
...
for dataset in predictions:
    ...
    ml.plot_model(features_pd=features_pd[dataset], labels=labels[dataset], predictions=predictions[dataset],
                 keys=keys, save_path=save_path, trans_to_pb=trans_to_pb, set_ylabel=r"$\rho$", set_ratio_yscale="linear",
                  autoscale_ratio=True, autoscale=True, automatic_legend=True, xticks=pi_ticks, xtick_labels=pi_names, colors=["C6"])
