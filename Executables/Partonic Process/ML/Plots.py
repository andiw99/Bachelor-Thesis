...
#Daten einlesen
diff_WQ_eta_data  = pd.read_csv(
    "//Files/Partonic/PartonicData/diff_WQ_eta_data")
theta_data = pd.read_csv("//Files/Partonic/PartonicData/ThetaData")
theta_test_data = pd.read_csv("//Files/Partonic/PartonicData/TestThetaData")
